...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <h4
      ...
      className={cn("text-xl font-semibold leading-tight sm:text-lg sm:leading-none", className)}
      {...filterFigmaProps(props)}
    />
  );
}
...
function CardContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("px-4 [&:last-child]:pb-4 sm:px-6 sm:[&:last-child]:pb-6", className)}
      {...filterFigmaProps(props)}
    />
  );
}
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("flex items-center px-4 pb-4 [.border-t]:pt-4 sm:px-6 sm:pb-6 sm:[.border-t]:pt-6", className)}
      {...filterFigmaProps(props)}
    />
  );
}
